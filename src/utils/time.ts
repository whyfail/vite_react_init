...
/**
 * 时间格式化函数
 * @param {string} date 时间  如：2024-1-1 11:11:11 或 时间戳
 * @param {'default' | '-' |  '/' | '.' | '年月日' |  '月日' | '年'} type 类型
 * @param {boolean} zeroFillFlag  为是否数字补零，默认补零
 * @return {string} 时间字符串
 * @example
 * formatPast('2024-1-1 11:11:11'); // 3天前
 * formatPast('2023-11-1 11:11:11'); // 2个月前
 * formatPast('2015-07-10 21:32:01'); // 8年前
 * formatPast('2023-02-01 09:32:01', '-', false); // 2023-2-1
 * formatPast('2023.12.8 19:32:01', '/'); // 2023/12/08
 * formatPast('2023.12.8 19:32:01', '.'); // 2023.12.08
 * formatPast('2023/5/10 11:32:01', '年月日'); // 2023年05月10日
